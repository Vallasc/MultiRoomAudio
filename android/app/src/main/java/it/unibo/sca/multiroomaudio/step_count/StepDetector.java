...
public class StepDetector {
    ...
    private static final float STEP_THRESHOLD_MAX = 30f;
    private static final float STEP_THRESHOLD_MIN = 20f;
    ...
    public void updateAccel(long timeNs, float x, float y, float z) {
        ...
        if (velocityEstimate < STEP_THRESHOLD_MAX && velocityEstimate > STEP_THRESHOLD_MIN
                && oldVelocityEstimate <= STEP_THRESHOLD_MIN && (timeNs - lastStepTimeNs > STEP_DELAY_NS)) {
